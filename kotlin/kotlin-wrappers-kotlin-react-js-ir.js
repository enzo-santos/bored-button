(function (root, factory) {
  ...
  function invoke(_this__u8e3s4, block) {
    this.i7(create(_this__u8e3s4, block));
  }
  ...
  protoOf(ChildrenBuilderImpl).i7 = unaryPlus;
  protoOf(ChildrenBuilderImpl).j7 = unaryPlus_0;
  protoOf(ChildrenBuilderImpl).h7 = child;
  protoOf(ChildrenBuilderImpl).k7 = invoke;
  //endregion
